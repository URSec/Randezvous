...
programs = {
    'cjpeg-rose7-preset': {
        ...
        'includes': [
            '${ProjDirPath}/src/benchmarks/consumer_v2/cjpeg/data',
    ...
    'core': {
        ...
        'directories': {
            'src': 'benchmarks/consumer_v2/|benchmarks/darkmark/|benchmarks/fp/|benchmarks/libbmp/|benchmarks/libjpeg/|mith/al/fdlibm/|mith/al/prism/|mith/al/soft/|mith/al/stub/|mith/al/win32/|workloads/cjpeg-rose7-preset/|workloads/linear_alg-mid-100x100-sp/|workloads/loops-all-mid-10k-sp/|workloads/nnet_test/|workloads/parser-125k/|workloads/radix2-big-64k/|workloads/sets/|workloads/sha-test/|workloads/zip-test/',
        },
    },
    'linear_alg-mid-100x100-sp': {
        ...
        'directories': {
            'src': 'benchmarks/consumer_v2/|benchmarks/core/|benchmarks/darkmark/|benchmarks/fp/fft_radix2/|benchmarks/fp/linpack/ref/data_big.c|benchmarks/fp/linpack/ref/data_mid.c|benchmarks/fp/linpack/ref/data_sml.c|benchmarks/fp/linpack/ref/inputs_f64.c|benchmarks/fp/loops/|benchmarks/fp/nnet/|benchmarks/fp/preset/|benchmarks/libbmp/|benchmarks/libjpeg/|mith/al/fdlibm/|mith/al/prism/|mith/al/soft/|mith/al/stub/|mith/al/win32/|workloads/cjpeg-rose7-preset/|workloads/core/|workloads/linear_alg-mid-100x100-sp/jni/|workloads/loops-all-mid-10k-sp/|workloads/nnet_test/|workloads/parser-125k/|workloads/radix2-big-64k/|workloads/sets/|workloads/sha-test/|workloads/zip-test/',
        },
    },
    ...
    'nnet_test': {
        ...
        'directories': {
            'src': 'benchmarks/consumer_v2/|benchmarks/core/|benchmarks/darkmark/|benchmarks/fp/fft_radix2/|benchmarks/fp/linpack/|benchmarks/fp/loops/|benchmarks/fp/nnet/ref-sp/|benchmarks/fp/preset/|benchmarks/libbmp/|benchmarks/libjpeg/|mith/al/fdlibm/|mith/al/prism/|mith/al/soft/|mith/al/stub/|mith/al/win32/|workloads/cjpeg-rose7-preset/|workloads/core/|workloads/linear_alg-mid-100x100-sp/|workloads/loops-all-mid-10k-sp/|workloads/nnet_test/jni/|workloads/parser-125k/|workloads/radix2-big-64k/|workloads/sets/|workloads/sha-test/|workloads/zip-test/',
        },
    },
    'parser-125k': {
        'defines': [ 'EZXML_NOMMAP=1', ],
        'includes': [
            '${ProjDirPath}/src/mith/include',
            '${ProjDirPath}/src/mith/al/include',
        ],
    ...
    'sha-test': {
        ...
        'directories': {
            'src': 'benchmarks/consumer_v2/|benchmarks/core/|benchmarks/darkmark/parser/|benchmarks/darkmark/zip/|benchmarks/fp/|benchmarks/libbmp/|benchmarks/libjpeg/|mith/al/fdlibm/|mith/al/prism/|mith/al/soft/|mith/al/stub/|mith/al/win32/|workloads/cjpeg-rose7-preset/|workloads/core/|workloads/linear_alg-mid-100x100-sp/|workloads/loops-all-mid-10k-sp/|workloads/nnet_test/|workloads/parser-125k/|workloads/radix2-big-64k/|workloads/sets/|workloads/sha-test/jni/|workloads/zip-test/',
        },
    },
    'zip-test': {
        'defines': [ 'MITH_MEMORY_ONLY_VERSION=1', ],
        'includes': [
