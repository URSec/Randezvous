...
#else
	real_items[0]=helper_ziptest(workload,retval,name,bmark_init_zip,bench_repeats,t_run_test_zip,bmark_clean_zip,bmark_fini_zip,bmark_verify_zip,1,(e_u32)1199388670,(e_u32)1851860219,&items[0]);
#endif
