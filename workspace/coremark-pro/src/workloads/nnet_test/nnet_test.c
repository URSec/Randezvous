...
#else
	real_items[0]=helper_nnettest(workload,retval,name,bmark_init_nnet,bench_repeats,t_run_test_nnet,bmark_clean_nnet,bmark_fini_nnet,bmark_verify_nnet,1,(e_u32)567581359,(e_u32)880349224,&items[0]);
#endif
