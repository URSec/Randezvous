...
#else
	real_items[0]=helper_core(workload,retval,name,bmark_init_core,bench_repeats,t_run_test_core,bmark_clean_core,bmark_fini_core,bmark_verify_core,1,(e_u32)257963578,(e_u32)2045561353,&items[0]);
#endif
