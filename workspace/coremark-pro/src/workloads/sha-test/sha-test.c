...
#else
	real_items[0]=helper_shatest(workload,retval,name,bmark_init_sha,bench_repeats,t_run_test_sha,bmark_clean_sha,bmark_fini_sha,bmark_verify_sha,1,(e_u32)560644875,(e_u32)709279032,&items[0]);
#endif
