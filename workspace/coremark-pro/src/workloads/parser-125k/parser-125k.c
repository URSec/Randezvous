...
#else
	real_items[0]=helper_parser125k(workload,retval,name,bmark_init_parser,bench_repeats,t_run_test_parser,bmark_clean_parser,bmark_fini_parser,bmark_verify_parser,1,(e_u32)38549450,(e_u32)718627353,&items[0]);
#endif
