...
#else
    (void (*)())&_image_size,          // Image length
#endif
    (void (*)())&__imghdr_imagetype,   // Image type
    0,                                 // Reserved
...
void ResetISR(void) {
    ...
    __asm volatile ("B    ResetISR_C       \n");
}

__attribute__ ((section(".after_vectors.reset"), used))
