...
libraries = {
    ...
    'mimxrt685s': {
        ...
        'includes': [
            ...
            '${workspace_loc:/mimxrt685s/component/osa}',
            ...
            '${workspace_loc:/mimxrt685s/pmic_driver}',
            '${workspace_loc:/mimxrt685s/sdmmc/host}',
            '${workspace_loc:/mimxrt685s/sdmmc/inc}',
            '${workspace_loc:/mimxrt685s/sdmmc/osa}',
...
components = {
    'fatfs': {
        'includes': [
            ...
            '${ProjDirPath}/fatfs/source/fsl_sd_disk',
        ],
        'directories': {
            'fatfs': '',
        },
